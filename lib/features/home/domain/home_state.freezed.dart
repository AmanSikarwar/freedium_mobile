...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeState&&(identical(other.url, _this.url) || other.url == _this.url));
}
...
String toString() {
  final _this = this as HomeState;
  return 'HomeState(url: ${_this.url})';
}
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _HomeState&&(identical(other.url, url) || other.url == url));
}
